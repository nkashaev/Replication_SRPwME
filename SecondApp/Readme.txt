...
This was done in a Linux Cluster https://docs.computecanada.ca/wiki/Niagara.
1. Install R 3.4.4
	...
	This file has been written on the basis of the files of revealedPrefs
	by Victor H. Aguiar and Nail Kashaev
	email: vhaguiar@gmail.com.
	It was modified under the terms of the GNU public license.
	The original file simul.cpp: Copyright 2014 Julien Boelaert.
	This file is part of revealedPrefs revealedPrefs is free software: you can redistribute it and/or modify
	it under the terms of the GNU General Public License.


2. Install Julia v"1.1.0"
