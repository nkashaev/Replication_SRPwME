...
@softscope for ri=1:1000
    ...
    res = bboptimize(objMCcu2; SearchRange = (-100e300,100e300), NumDimensions = 4,MaxTime = 400.0, Method=:probabilistic_descent, TraceMode=:silent)
...
########
    ...
    CSV.write(dirresults*"/lancemachine_power_cuda_start.$startit.end.$endit.csv",Resultspower)
    GC.gc()
