...
if computer=="teslamachine"
    basedir="C:/Users/vaguiar/Dropbox/ReaplicationAK/"
    rootdir=""
end
...
#CSV.write()
CSV.write(dirresults*"/results_TS_cuda_$avgdelta.csv",Results1)
CSV.write(dirresults*"/results_gamma_cuda_$avgdelta.csv",Results1gamma)
