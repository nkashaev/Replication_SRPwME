...
@softscope for ri=1:1000
    ...
    ## Data generation
    ##Hyperbolic
    include(rootdir*"/restud_apppower/powerfunctions/hyperbolicgenerator_simulations_2019_12_04theta0.0.8.jl")

    ## Collective
    #include(rootdir*"/restud_apppower/powerfunctions/couples_generator_simulations_2019_11_08.jl")
...
########
    ...
    CSV.write(dirresults*"/$hypothesis._$computer._power_cuda_start.$startit.end.$endit.csv",Resultspower)
    GC.gc()
