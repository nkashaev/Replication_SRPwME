...
@everywhere const repn=(0,2000000)
...
#CSV.write()
CSV.write(dirresults*"/IncomeUncertaintymean_2million__results_TS_cuda_$theta0.csv",Results1)
CSV.write(dirresults*"/IncomeUncertaintymean_2million__results_gamma_cuda_$theta0.csv",Results1gamma)
