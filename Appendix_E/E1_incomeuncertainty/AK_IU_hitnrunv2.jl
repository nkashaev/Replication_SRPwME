...
@everywhere const repn=(0,1000000)
...
## moments
## Moment: my function
include(rootdir*appname*"/cpufunctions/myfun_IU.jl")
...
#CSV.write()
CSV.write(dirresults*"/GARP_results_TS_cuda_$theta0.csv",Results1)
CSV.write(dirresults*"/GARP_results_gamma_cuda_$theta0.csv",Results1gamma)
