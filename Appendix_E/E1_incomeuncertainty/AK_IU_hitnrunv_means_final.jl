...
include(rootdir*appname*"/cudafunctions/cuda_chainfun_IU_means.jl")
...
#CSV.write()
CSV.write(dirresults*"/IncomeUncertaintymean_1.5million__results_TS_cuda_$theta0.v3.csv",Results1)
CSV.write(dirresults*"/IncomeUncertaintymean_1.5million__results_gamma_cuda_$theta0.v3.csv",Results1gamma)
