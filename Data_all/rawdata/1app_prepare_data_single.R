...
##input files
dir="C:\\Users\\pegas\\Documents\\GitHub\\ReplicationAK\\Data_all\\rawdata"
irate.file=paste(dir,"\\","ir.mat",sep="")
expprice.file=paste(dir,"\\","ecpf_data.mat",sep="")

## output files
dirout="C:\\Users\\pegas\\Documents\\GitHub\\ReplicationAK\\Data_all"
p.file=paste(dirout,"\\","p.csv",sep="")
cve.file=paste(dirout,"\\","cve.csv",sep="")
rv.file=paste(dirout,"\\","rv.csv",sep="")
...
ind.single=which(ecpf.data$hh.pricedata.all[,5]==0)
